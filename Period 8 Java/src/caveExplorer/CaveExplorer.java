...
public class CaveExplorer {
	public static CaveRoomJoey[][] caves;
	public static Scanner in;
	public static CaveRoomJoey currentRoom;
	...
	public static void main(String[] args){
		...
		caves = new CaveRoomJoey[5][5];
		for(int row = 0; row<caves.length; row++){
			for(int col = 0; col<caves[row].length; col++){
				caves[row][col] = new CaveRoomJoey("This room has coordinates "+row+", " +col);
			}
		}
